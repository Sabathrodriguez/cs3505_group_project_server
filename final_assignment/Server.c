/*	Socket programming in C and C++ tutorial
...
int main()
{
    time_t clock;
        ...
        ipOfServer.sin_port = htons(1100); 		// this is the port number of running server
        ...
        while(1)
        {
                ...
                snprintf(dataSending, sizeof(dataSending), "%.24s", "test1"); // Printing successful message
//                send(clintConnt , dataSending , strlen(dataSending) , 0 );
